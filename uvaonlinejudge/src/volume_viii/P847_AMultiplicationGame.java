...
/**
 * UVa Online Judge - Problem 847: A Multiplication Game
 * 
 * @author Fernando Cardoso (fernandohbc@gmail.com)
 */
public class P847_AMultiplicationGame {
  public static void main(String[] args) {
    Scanner scn = new Scanner(System.in);
    while (scn.hasNextLong()) {
      long n = scn.nextLong();
      while (n > 9) {
        n = Math.round(Math.ceil(n/18.0));
      }
      System.out.println((n==1?"Ollie":"Stan") + " wins.");
    }
  }
}
