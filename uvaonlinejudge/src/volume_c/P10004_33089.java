...
class P10004_33089 {
    ...
    private void begin() {
        int qtdVertices = Integer.parseInt(P10004_33089.readLn());
        while (qtdVertices != 0) {
            Graph g = new Graph(qtdVertices);
            int qtdArestas = Integer.parseInt(P10004_33089.readLn());
            for (int a = 0; a < qtdArestas; a++) {
                String input = P10004_33089.readLn();
            ...
            qtdVertices = Integer.parseInt(P10004_33089.readLn());
        }
    }
}
...
class Graph {
    ...
    public Graph(int qtdVertices) {
        this.graph = new boolean[qtdVertices][];
        for (int i = 0; i < qtdVertices; i++) {
            this.graph[i] = new boolean[qtdVertices];
        }
    }

    public boolean isBipartite() {
        int qtdVertices = this.graph.length;
